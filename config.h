...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xc4ced4ff, 0x27251f5d, 0x27251fff },
	[SchemeSel]  = { 0x9bf6ffff, 0x27251f5d, 0x9bf6ffff },
...
static const float default_mfact = 0.55f;
...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ "eDP-1",    default_mfact, 1,      2,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
	{ NULL,       default_mfact, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
...
static const struct xkb_rule_names xkb_rules = {
	...
	.options = "ctrl:nocaps",
	*/
	.options = "grp:shift_caps_toggle,caps:escape",
  .layout = "us,de,bg",
  .variant = ", , phonetic"
};
...
static const Key keys[] = {
  ...
  /* Utils */
	{ 0,                         -1, XKB_KEY_XF86MonBrightnessUp,   spawn,       {.v = brightnessupcmd} },
	{ 0,                         -1, XKB_KEY_XF86MonBrightnessDown, spawn,       {.v = brightnessdowncmd} },
  ...
  /* System */
	...
	{ MODKEY,                    -1, XKB_KEY_l,          focusstack,     {.i = +1} },
	{ MODKEY,                    -1, XKB_KEY_h,          focusstack,     {.i = -1} },
	{ MODKEY|WLR_MODIFIER_SHIFT, -1, XKB_KEY_plus,       setmfact,       {.f = +0.05f} },
	{ MODKEY,                    -1, XKB_KEY_minus,      setmfact,       {.f = -0.05f} },
	{ MODKEY,                    -1, XKB_KEY_equal,      setmfact,       {.f = 1.0f + default_mfact} },
	{ MODKEY,                    -1, XKB_KEY_s,          zoom,           {0} },
